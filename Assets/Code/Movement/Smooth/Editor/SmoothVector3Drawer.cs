  ...
  public class SmoothVector3Drawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect origin, SerializedProperty property, GUIContent label) {
      ...
      Handles.DrawAAPolyLine(
        ...
        THICKNESS,
        moveStart * SCALE,
        moveStart * SCALE + Vector3.right * rect.width
      );
      ...
      Handles.DrawAAPolyLine(
        ...
        THICKNESS,
        moveFinish * SCALE,
        moveFinish * SCALE + Vector3.right * rect.width
      );
      Handles.color = Color.green;
      Handles.DrawAAPolyLine(
        Texture2D.whiteTexture,
        THICKNESS,
        GetPoints(value, moveStart, moveFinish, rect)
      );
      GUI.EndClip();
    }
    ...
    public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
      return property.isExpanded
        ? EditorGUI.GetPropertyHeight(property) + HEIGHT
